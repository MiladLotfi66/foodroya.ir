          ...
          <div className="bg-white dark:bg-zinc-700 shadow-lg rounded-2xl mt-16 p-8 md:p-12 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-8">
                ...
                <div className="w-full text-center">
                  {editField === "userUniqName" ? (
                    ...
                    <h2
                      ...
                      tabIndex={0}
                      role="button"
                      onKeyPress={(e) => e.key === 'Enter' && setEditField("userUniqName")}
              ...
              <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="w-full flex flex-col">
                  ...
                  {editField === "phone" ? (
                    ...
                    <span
                      ...
                      tabIndex={0}
                      role="button"
                      onKeyPress={(e) => e.key === 'Enter' && setEditField("phone")}
                  ...
                  {editField === "email" ? (
                    ...
                    <>
                      ...
                      <span
                        ...
                        tabIndex={0}
                        role="button"
                        onKeyPress={(e) => e.key === 'Enter' && setEditField("email")}
                ...
                {/* تاریخ تولد */}
                <div className="w-full flex flex-col">
                  <label htmlFor="dateOfBirth" className="mb-2 text-gray-700 dark:text-gray-300">
                    تاریخ تولد
                  </label>
                  <Controller
                    control={control}
            ...
            ذخیره
              ...
              <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="w-full flex flex-col">
                  {editField === "address" ? (
                    <>
                      <label htmlFor="address" className="mb-2 text-gray-700 dark:text-gray-300">
                        آدرس
                      </label>
                      <textarea
                        id="address"
                    ...
                    <>
                      ...
                      <span
                        ...
                        tabIndex={0}
                        role="button"
                        onKeyPress={(e) => e.key === 'Enter' && setEditField("address")}
                  ...
                  {editField === "bio" ? (
                    ...
                    <>
                      ...
                      <span
                        ...
                        tabIndex={0}
                        role="button"
                        onKeyPress={(e) => e.key === 'Enter' && setEditField("bio")}
