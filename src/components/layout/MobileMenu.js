"use client";
import {selectmobileMenu ,reversemobileMenu} from "../../Redux/features/mobileMenu/mobileMenuSlice";
    ...
    <>
      ...
      >
        ...
        <div className="flex justify-between  items-center mx-4 mt-3 mb-6 border-b border-b-gray-300 dark:border-b-white/10 pb-5">
          ...
          <svg onClick={() => dispatch(reversemobileMenu())} className=" w-5 h-5  text-zinc-600 dark:text-white">
            <use href="#Xmark"></use>
          </svg>
        </div>
        {/* ************************ nav menu ************************ */}
        <ul className="text-orange-300 mr-2.5 px-4 flex flex-col gap-y-4 child:child:flex child:child:gap-x-2 ">
          ...
          <li onClick={() => setShopSubmenu(!shopSubMenu)}>
            <a className="justify-between">
              ...
              <span>
                <svg className={shopSubMenu ? "w-5 h-5 rotate-180" : "w-5 h-5"}>
